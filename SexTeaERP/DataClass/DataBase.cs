...
namespace SexTeaERP.DataClass
{
    ...
    public class DataBase
    {
        ...
        public DataBase()
        {
            ...
            //读取数据库配置文件
            string strServer = OperatorFile.GetIniFileString("DataBase", "Server", "", System.Environment.CurrentDirectory + "\\SexTeaERP.ini");
            //获取登录用户
            string strUserID = OperatorFile.GetIniFileString("DataBase", "UserID", "", System.Environment.CurrentDirectory + "\\SexTeaERP.ini");
            //获取登录密码
        ...
        {
            int intReturnValue; //受影响的行数

            m_Cmd.CommandType = CommandType.Text;   //SQL 命令
